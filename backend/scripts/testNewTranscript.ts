/**
 * Test with the exact transcript from user screenshot
 */

import { extractTasksMock } from '../src/lib/mockExtractor.js';
...
console.log('Testing backend extraction with new transcript...\n');
