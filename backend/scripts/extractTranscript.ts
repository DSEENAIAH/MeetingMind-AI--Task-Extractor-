import { extractTasksMock } from '../src/lib/mockExtractor';
...
The project planning meeting style transcript:
...
const result = extractTasksMock(transcript);

console.log('--- Extracted Tasks ---');
console.log('Count:', result.tasks.length);
for (const t of result.tasks) {
  console.log({ title: t.title, assignee: t.assignee, dueDate: t.dueDate, priority: t.priority });
}
